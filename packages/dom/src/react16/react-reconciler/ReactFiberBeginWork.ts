...
function updateMemoComponent(
  ...
  let currentChild = (current.child as Fiber); // This is always exactly one child
...
function mountLazyComponent(
  ...
  const resolvedTag = (workInProgress.tag = resolveLazyComponentTag(Component as any));
  ...
  switch (resolvedTag) {
    ...
    case MemoComponent: {
      ...
      child = updateMemoComponent(
        ...
        workInProgress,
        Component,
        resolveDefaultProps((Component as any).type, resolvedProps), // The inner type can have defaults too
        updateExpirationTime,
        renderExpirationTime,
      );
      break;
