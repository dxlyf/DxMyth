...
import { createWorkInProgress, Fiber } from './ReactFiber';
import {
  NoWork,
  Sync,
  Never,
...
import { resetContextDependences } from './ReactFiberNewContext';
...
function commitRoot(root: FiberRoot, finishedWork: Fiber): void {
  ...
  let prevInteractions: Set<any> = (null as any);
...
let completedBatches: Array<any> | null = null;
    ...
    if (!shouldYieldToRenderer()) {
      ...
      if (firstScheduledRoot !== null) {
        ...
        do {
          ...
          root = (root.nextScheduledRoot as any);
