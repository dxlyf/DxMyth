...
function renderInternal(input, parentDOM, callback, context) {
  ...
  if (isNullOrUndef(rootInput)) {
    if (!isNullOrUndef(input)) {
      if ((input.flags & 16384 /* VNodeFlags.InUse */) !== 0) {
