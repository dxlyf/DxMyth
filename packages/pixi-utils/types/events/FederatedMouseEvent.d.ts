...
import { FederatedEvent, PixiTouch } from './FederatedEvent';
 ...
 * @standard
 */
export declare class FederatedMouseEvent<Container = unknown> extends FederatedEvent<MouseEvent | PointerEvent | PixiTouch> implements MouseEvent {
     ...
     */
    getLocalPosition<P extends PointData = Point>(container: Container | any, point?: P, globalPos?: PointData): P;
    /**
