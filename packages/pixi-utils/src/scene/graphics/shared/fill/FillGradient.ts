...
import { deprecation } from 'src/utils/logging/deprecation';
...
import { ImageSource } from '../texture/sources/ImageSource';
import { CanvasAndContext } from '../texture/CanvasPool';
...
export class FillGradient implements CanvasGradient
{
    ...
    private readonly _wrapMode: any;
