...
import { Bounds } from 'src/maths/misc/Bounds';
...
}>
{
     ...
     */
    public destroy(options:any= false): void
    {
        ...
        if (destroyTexture)
        {
            ...
            if (this._fillStyle.texture)
            {
                this._fillStyle.fill && 'uid' in this._fillStyle.fill
                    ? (this._fillStyle.fill as any).destroy()
            ...
            if (this._strokeStyle.texture)
            {
                this._strokeStyle.fill && 'uid' in this._strokeStyle.fill
                    ? (this._strokeStyle.fill as any).destroy()
