...
export  function earcut(data:ArrayLike<number>, holeIndices:ArrayLike<number>, dim:number = 2) {
...
function linkedList(data:any, start:any, end:any, dim:any, clockwise:boolean) {
    let last;
...
function cureLocalIntersections(start:any, triangles:any) {
    let p = start;
    do {
        const a = p.prev,
            b = p.next.next;
...
function compareXYSlope(a:any, b:any) {
    let result = a.x - b.x;
...
function pointInTriangle(ax:any, ay:any, bx:any, by:any, cx:any, cy:any, px:any, py:any) {
...
function pointInTriangleExceptFirst(ax:any, ay:any, bx:any, by:any, cx:any, cy:any, px:any, py:any) {
...
function splitPolygon(a:any, b:any) {
    const a2 = createNode(a.i, a.x, a.y),
        b2 = createNode(b.i, b.x, b.y) as any,
        an = a.next,
        bp = b.prev;
...
function insertNode(i:any, x:any, y:any, last:any) {
    const p = createNode(i, x, y) as any;
...
function signedArea(data:any, start:any, end:any, dim:any) {
    let sum = 0;
