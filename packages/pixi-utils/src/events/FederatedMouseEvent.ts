 ...
 * @standard
 */
export class FederatedMouseEvent<Container=unknown> extends FederatedEvent<
...
> implements MouseEvent
{
     ...
     */
    public getLocalPosition<P extends PointData = Point>(container: Container|any, point?: P, globalPos?: PointData): P
    {
