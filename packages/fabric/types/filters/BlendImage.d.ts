...
import { T2DPipelineState, TWebGLPipelineState, TWebGLUniformLocationMap } from './typedefs';
...
export declare class BlendImage extends BaseFilter<'BlendImage', BlendImageOwnProps> {
    ...
    createTexture(backend: WebGLFilterBackend, image: FabricImage): WebGLTexture;
    /**
