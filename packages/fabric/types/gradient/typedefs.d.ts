...
export type GradientCoords<T extends GradientType> = T extends 'linear' ? LinearGradientCoords<number> : RadialGradientCoords<number>;
...
export type SerializedGradientProps<T extends GradientType> = Omit<GradientOptions<T>, 'id'>;
