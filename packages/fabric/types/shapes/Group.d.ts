import { CollectionEvents, ObjectEvents } from '../EventTypeDefs';
import { TClassProperties, TSVGReviver, TOptions, Abortable } from '../typedefs';
import { FabricObject } from './Object/FabricObject';
import { FabricObjectProps, SerializedObjectProps } from './Object/types';
import { ImperativeLayoutOptions, LayoutBeforeEvent, LayoutAfterEvent } from '../LayoutManager/types';
import { LayoutManager, SerializedLayoutManager } from '../LayoutManager/LayoutManager';
...
declare const Group_base: {
    new (...args: any[]): {
        ...
        findNewLowerIndex(object: FabricObject, idx: number, intersecting?: boolean): any;
        findNewUpperIndex(object: FabricObject, idx: number, intersecting?: boolean): any;
...
export declare class Group extends Group_base implements GroupProps {
     ...
     * @private
     */
    _createSVGBgRect(reviver?: TSVGReviver): any;
    /**
