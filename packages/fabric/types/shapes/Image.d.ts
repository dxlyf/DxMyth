...
import { TClassProperties, TCrossOrigin, TSize, Abortable, TOptions } from '../typedefs';
...
import { CSSRules } from '../parser/typedefs';
import { Resize, ResizeSerializedProps } from '../filters/Resize';
import { TCachedFabricObject } from './Object/Object';
...
export declare class FabricImage<Props extends TOptions<ImageProps> = Partial<ImageProps>, SProps extends SerializedImageProps = SerializedImageProps, EventSpec extends ObjectEvents = ObjectEvents> extends FabricObject<Props, SProps, EventSpec> implements ImageProps {
     ...
     */
    static fromElement(element: HTMLElement, options?: Abortable, cssRules?: CSSRules): Promise<any>;
}
export {};
