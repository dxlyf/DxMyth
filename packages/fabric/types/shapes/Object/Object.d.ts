...
import { TDegree, TFiller, TCacheCanvasDimensions, Abortable, TOptions, ImageFormat } from '../../typedefs';
...
import { TColorArg } from '../../color/typedefs';
import { TAnimation } from '../../util/animation/animate';
import { AnimationOptions } from '../../util/animation/types';
...
export declare class FabricObject<Props extends TOptions<ObjectProps> = Partial<ObjectProps>, SProps extends SerializedObjectProps = SerializedObjectProps, EventSpec extends ObjectEvents = ObjectEvents> extends ObjectGeometry<EventSpec> implements ObjectProps {
     ...
     */
    _limitCacheSize(dims: TCacheCanvasDimensions & {
        capped?: boolean;
    ...
    toBlob(options?: toDataURLOptions): Promise<Blob>;
    /**
