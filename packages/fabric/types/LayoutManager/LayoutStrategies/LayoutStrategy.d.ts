...
import { InitializationLayoutContext, LayoutStrategyResult, StrictLayoutContext } from '../types';
/**
...
export declare abstract class LayoutStrategy {
    ...
    shouldLayoutClipPath({ type, target: { clipPath } }: StrictLayoutContext): boolean;
