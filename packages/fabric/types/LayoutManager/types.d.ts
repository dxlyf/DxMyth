import { BasicTransformEvent, ModifiedEvent, TModificationEvents } from '../EventTypeDefs';
import { Point } from '../Point';
import { Group } from '../shapes/Group';
import { ITextEvents } from '../shapes/IText/ITextBehavior';
import { FabricObject } from '../shapes/Object/FabricObject';
import { LayoutStrategy } from './LayoutStrategies/LayoutStrategy';
import { LAYOUT_TYPE_INITIALIZATION, LAYOUT_TYPE_ADDED, LAYOUT_TYPE_IMPERATIVE, LAYOUT_TYPE_REMOVED, LAYOUT_TYPE_OBJECT_MODIFIED, LAYOUT_TYPE_OBJECT_MODIFYING } from './constants';
export type LayoutTrigger = typeof LAYOUT_TYPE_INITIALIZATION | typeof LAYOUT_TYPE_OBJECT_MODIFYING | typeof LAYOUT_TYPE_OBJECT_MODIFIED | typeof LAYOUT_TYPE_ADDED | typeof LAYOUT_TYPE_REMOVED | typeof LAYOUT_TYPE_IMPERATIVE;
...
export type ImperativeLayoutContext = CommonLayoutContext & ImperativeLayoutCommonOptions & {
    type: typeof LAYOUT_TYPE_IMPERATIVE;
};
export type LayoutContext = InitializationLayoutContext | CollectionChangeLayoutContext | ObjectModifiedLayoutContext | ObjectModifyingLayoutContext | ImperativeLayoutContext;
