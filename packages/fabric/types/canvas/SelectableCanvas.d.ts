...
import { TCanvasSizeOptions, StaticCanvas } from './StaticCanvas';
import { TMat2D, TOriginX, TOriginY, TSize, TSVGReviver } from '../typedefs';
...
export declare class SelectableCanvas<EventSpec extends CanvasEvents = CanvasEvents> extends StaticCanvas<EventSpec> implements Omit<CanvasOptions, 'enablePointerEvents'> {
     ...
     * @private
     */
    _searchPossibleTargets(objects: FabricObject[], pointer: Point, subTargets: FabricObject[]): TargetsInfo;
    /**
     ...
     */
    searchPossibleTargets(objects: FabricObject[], pointer: Point): TargetsInfoWithContainer;
    /**
