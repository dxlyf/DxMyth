...
import { TFiller, TMat2D, TOptions } from '../typedefs';
...
export interface StaticCanvasOptions extends CanvasDrawableOptions, CanvasRenderingOptions, CanvasExportOptions {
    /**
...
export declare const staticCanvasDefaults: TOptions<StaticCanvasOptions>;
export {};
