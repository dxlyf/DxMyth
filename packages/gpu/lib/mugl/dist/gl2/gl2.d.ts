...
import { BindGroup, BindGroupLayout, Buffer, Color, Device, Extent2D, Extent3D, Future, MipmapHint, RenderPass, RenderPipeline, Sampler, Shader, Texture, UInt, UIntArray } from '../gpu';
import { BindGroupDescriptor, BindGroupLayoutDescriptor, BufferDescriptor, ImageCopyExternalImage, ImageCopyTexture, ImageDataLayout, RenderPassDescriptor, RenderPipelineDescriptor, SamplerDescriptor, ShaderDescriptor, TextureDescriptor } from '../gpu';
 ...
 */
export declare function requestWebGL2Device(canvas: Canvas | WebGL2RenderingContextProvider, options?: WebGLContextAttributes, features?: WebGL2Feature): Device | null;
/**
 ...
 */
export declare function createBindGroupLayout(_: Device, desc: BindGroupLayoutDescriptor): BindGroupLayout;
/**
 ...
 */
export declare function copyExternalImageToTexture(device: Device, src: ImageCopyExternalImage<TexImageSource>, dst: ImageCopyTexture, size?: Extent2D): void;
/**
