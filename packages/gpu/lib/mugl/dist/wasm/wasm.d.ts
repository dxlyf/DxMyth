import { AddressMode, BufferUsage, CompareFunction, CullMode, Device, FilterMode, Float, FrontFace, FutureStatus, GPU, IndexFormat, MipmapHint, PrimitiveTopology, ShaderStage, StencilOperation, TextureDimension, TextureFormat, TextureUsage, UInt } from '../gpu';
 ...
 */
export declare function set_image_by_id(id: string, image: TexImageSource): ImageSourceId;
/**
 ...
 * @returns device ID
 */
export declare function set_device(context: ContextId, device: Device, canvasId?: string, gpu?: GPU): ResourceId;
...
export declare function get_future_value(future: FutureId): ResourceId;
...
export declare function delete_canvas(canvas: CanvasId): void;
export declare function webgpu_request_device(canvasId: CanvasId, attrs: UInt, features: UInt): FutureId;
export declare function webgpu_create_surface_texture(deviceId: ResourceId, canvasId: CanvasId, attrs?: UInt): ResourceId;
export declare function webgpu_create_surface_depth_texture(deviceId: ResourceId, canvasId: CanvasId, attrs?: UInt): ResourceId;
...
export declare function flush(device: ResourceId): void;
