...
export class Tween {
     ...
     * @returns {Object} Tween。
     */
    static remove(tweenOrTarget:Array<Tween>|Tween|Object) {
        var i, l;
     ...
     */
    static fromTo(target:any|any[], fromProps:any, toProps:any, params:any) {
        params = params || {};
     ...
     * @returns {Tween|Array} 一个Tween实例对象或Tween实例数组。
     */
    static to(target:any, toProps:any, params:any) {
     ...
     * @returns {Tween|Array} 一个Tween实例对象或Tween实例数组。
     */
    static from(target:any, fromProps:any, params:any) {
    ...
    constructor(target:any, fromProps:any, toProps:any, params:any) {
        var me = this;
     ...
     */
    setProps(fromProps:any, toProps:any) {
     ...
     * @private
     */
    _update(time:number, forceUpdate:boolean=true) {
        var me = this;
