import { IProduceWithPatches, IProduce, ImmerState, Drafted, Patch, Objectish, Draft, PatchListener, ImmerScope } from '../internal';
...
export declare function createProxy<T extends Objectish>(rootScope: ImmerScope, value: T, parent?: ImmerState, key?: string | number | symbol): Drafted<T, ImmerState>;
export {};
