...
export class RadialCanvasGradient{
  _shader:CanvasKit.Shader
  _colors:CanvasKit.Color[]
  _pos:number[]
  constructor(public x1:number,public  y1:number,public  r1:number,public  x2:number, public y2:number,public  r2:number){
    this._shader = null;
    this._colors = [];
    this._pos = [];
  ...
  _copy() {
    var rcg = new RadialCanvasGradient(this.x1, this.y1, this.r1, this.x2, this.y2, this.r2);
  ...
  _getShader(currentTransform:number[]) {
    ...
    CK.Matrix.mapPoints(currentTransform, pts);
    var sx1 = pts[0];
    var sy1 = pts[1];
    var sx2 = pts[2];
    var sy2 = pts[3];
    ...
    var sr1 =this.r1 * scaleFactor;
    var sr2 = this.r2 * scaleFactor;
