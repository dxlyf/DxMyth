...
class ImageLoader extends Loader<HTMLImageElement> {
	 ...
	 */
	load( url:string, onLoad:OnLoadCallback<HTMLImageElement>, onProgress?:OnProgressCallback, onError?:OnErrorCallback ) {
		...
		const image = createElementNS('http://www.w3.org/1999/xhtml', 'img' ) as HTMLImageElement;
		...
		function onImageError(this:HTMLImageElement, event:any ) {
