...
const loading:Record<string,Array<{onLoad:OnLoadCallback<any>,onProgress?:OnProgressCallback,onError?:OnErrorCallback}>> = {};
 ...
 * @augments Loader
 */
class FileLoader<TData=any> extends Loader<TData> {
	declare mimeType:string
	declare responseType:ResposeType
	 ...
	 */
	load( url:string, onLoad:OnLoadCallback<TData>, onProgress?:OnProgressCallback, onError?:OnErrorCallback ) {
	 ...
	 */
	setResponseType( value:ResposeType ) {
