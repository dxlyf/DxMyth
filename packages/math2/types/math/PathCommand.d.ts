 ...
 */
/** 命令类型枚举 */
export declare const enum PathCommandType {
    /** 开始新路径，清空当前路径 */
    BeginPath = "beginPath",
    /** 移动到指定点，作为新子路径的起点 */
    MoveTo = "moveTo",
...
/** 所有路径命令的联合类型 */
export type PathCommandLike = BeginPathCommand | MoveToCommand | LineToCommand | QuadraticCurveToCommand | BezierCurveToCommand | ArcCommand | ArcToCommand | EllipseCommand | RectCommand | RoundRectCommand | ClosePathCommand;
/**
 * PathCommand - 路径命令类
...
export declare class PathCommand {
    ...
    /** Arc / Ellipse 的逆时针标志 */
    counterclockwise?: boolean;
    constructor(type: PathCommandType, args?: number[], extra?: {
        radii?: number | DOMPointInit | (number | DOMPointInit)[];
        counterclockwise?: boolean;
    });
    /** 开始新路径 */
    ...
    /** 三次贝塞尔曲线 */
    static bezierCurveTo(cp1x: number, cp1y: number, cp2x: number, cp2y: number, x: number, y: number): PathCommand;
    /** 圆弧 */
    static arc(x: number, y: number, radius: number, startAngle: number, endAngle: number, counterclockwise?: boolean): PathCommand;
    /** 切线圆弧 */
    static arcTo(x1: number, y1: number, x2: number, y2: number, radius: number): PathCommand;
    /** 椭圆弧 */
    static ellipse(x: number, y: number, radiusX: number, radiusY: number, rotation: number, startAngle: number, endAngle: number, counterclockwise?: boolean): PathCommand;
    /** 矩形 */
    static rect(x: number, y: number, w: number, h: number): PathCommand;
    /** 圆角矩形 */
    static roundRect(x: number, y: number, w: number, h: number, radii?: number | DOMPointInit | (number | DOMPointInit)[]): PathCommand;
    /** 关闭路径 */
