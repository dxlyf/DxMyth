...
import { DOMPointInit, ICanvasRenderingContext2D } from './types';
/**
 ...
 */
export declare function roundRect(this: Path2D | ICanvasRenderingContext2D, x: number, y: number, width: number, height: number, radii?: number | DOMPointInit | (number | DOMPointInit)[]): void;
