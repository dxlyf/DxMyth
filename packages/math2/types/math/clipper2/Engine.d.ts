...
export declare const ClipperEngine: {
    addLocMin(vert: Vertex, polytype: PathType, isOpen: boolean, minimaList: LocalMinima[]): void;
    addPathsToVertexList(paths: Paths64, polytype: PathType, isOpen: boolean, minimaList: LocalMinima[], vertexList: Vertex[]): void;
};
...
export declare class ClipperBase {
    ...
    *******************************************************************************/
    ...
    private static isMaximaVertex;
    private static isMaximaEdge;
