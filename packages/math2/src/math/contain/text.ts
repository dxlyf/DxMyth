import { BoundingRect,type BoundingRectLike } from '../BoundingRect';
import LRU from '../LRU';
import { DEFAULT_FONT, platformApi } from '../platform';

type BuiltinTextPosition = 'left' | 'right' | 'top' | 'bottom' | 'inside'
