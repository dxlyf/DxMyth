...
import {vec2,type Vec2Like} from '../gl-matrix/vec2';
...
export default class PathProxy {
    ...
    setScale(sx: number, sy: number, segmentIgnoreThreshold?: number) {
        ...
        if (segmentIgnoreThreshold > 0) {
            this._ux = mathAbs(segmentIgnoreThreshold / this.dpr / sx) || 0;
            this._uy = mathAbs(segmentIgnoreThreshold / this.dpr / sy) || 0;
        }
    }
        ...
        for (i = 0; i < this._len;) {
            ...
            switch (cmd) {
                case CMD.M:
                    ...
                    break;
                case CMD.L:
                    fromLine(xi, yi, data[i], data[i + 1], min2 as Vec2Like, max2 as Vec2Like);
                    xi = data[i++];
                    yi = data[i++];
                    break;
                case CMD.C:
                    fromCubic(
                        ...
                        min2 as Vec2Like, max2 as Vec2Like
                    );
                    xi = data[i++];
                    yi = data[i++];
                    break;
                ...
                case CMD.A:
                    ...
                    fromArc(
                        ...
                        anticlockwise, min2 as Vec2Like, max2 as Vec2Like
                    );
                ...
                case CMD.R:
                    ...
                    const height = data[i++];
                    // Use fromLine
                    fromLine(x0, y0, x0 + width, y0 + height, min2 as Vec2Like, max2 as Vec2Like);
                    break;
                case CMD.Z:
                    xi = x0;
                    yi = y0;
            ...
            // Union
            vec2.min(min as Vec2Like, min as Vec2Like, min2 as Vec2Like);
            vec2.max(max as Vec2Like, max as Vec2Like, max2 as Vec2Like);
        }
