...
function getObserverFromMirror(mirror: Mirror, callback:any): ObserverInfo {
  return mirror.observers.get(callback)
}

function removeObserverFromMirror(mirror: Mirror, observer:any): void {
...
function _generate(mirror:any, obj:any, patches:any, path:any, invertible:any) {
  if (obj === mirror) {
    return;
  }
