...
export const enableAlwaysYieldScheduler =true;
...
const localSetImmediate =
  typeof (globalThis as any).setImmediate !== 'undefined' ? (globalThis as any).setImmediate : null; // IE and Node.js + jsdom
...
function unstable_wrapCallback(callback: (this:any,...args:any[])=>any) {
