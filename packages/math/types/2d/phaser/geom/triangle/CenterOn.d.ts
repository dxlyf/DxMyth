...
export type CenterFunction = (triangle: Phaser.Geom.Triangle) => Phaser.Math.Vector2;
/**
 ...
 */
declare function CenterOn(triangle: Phaser.Geom.Triangle, x: number, y: number, centerFunc?: CenterFunction): Phaser.Geom.Triangle;
