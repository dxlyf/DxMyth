...
type f32 = number;
declare function find_quad_extrema(a: f32, b: f32, c: f32): number;
...
declare class Conic {
    ...
    compute_quad_pow2(tolerance: f32): number;
...
declare class AutoConicToQuads {
    points: Vector2[];
    len: number;
    static compute(pt0: Vector2, pt1: Vector2, pt2: Vector2, weight: f32): AutoConicToQuads;
    constructor(options?: {});
}
