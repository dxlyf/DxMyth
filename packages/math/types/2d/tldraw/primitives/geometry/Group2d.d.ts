...
export declare class Group2d extends Geometry2d {
    ...
    intersectLineSegment(A: VecLike, B: VecLike, filters?: Geometry2dFilters): any[];
    intersectCircle(center: VecLike, radius: number, filters?: Geometry2dFilters): any[];
    getBoundsVertices(): Vec[];
    intersectPolygon(polygon: VecLike[], filters?: Geometry2dFilters): any[];
    intersectPolyline(polyline: VecLike[], filters?: Geometry2dFilters): any[];
