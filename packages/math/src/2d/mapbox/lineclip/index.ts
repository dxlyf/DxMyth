...
function lineclip(points:Point[], bbox:BBox, result:Point[][]=[]) {

    var len = points.length,
        codeA = bitCode(points[0], bbox),
        part:Point[] = [],
        i, a:Point|null, b:Point|null, codeB, lastCode;
...
function polygonclip(points:Point[], bbox:BBox) {

    var result:Point[]=[], edge, prev, prevInside, i, p, inside;
...
function intersect(a:Point, b:Point, edge:number, bbox:BBox) {
