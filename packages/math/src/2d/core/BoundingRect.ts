import {Matrix2D as matrix,Matrix2dLike} from '../math/mat2d';
import Point, { PointLike } from '../math/point';
...
class BoundingRect {
    ...
    static applyTransform(target: RectLike, source: RectLike, m: Matrix2dLike) {
