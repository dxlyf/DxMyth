...
function containPath(
    path: ProxyPath2D, lineWidth: number, isStroke: boolean, x: number, y: number
): boolean {
...
export function contain(pathProxy: ProxyPath2D, x: number, y: number): boolean {
    return containPath(pathProxy, 0, false, x, y);
}

export function containStroke(pathProxy: ProxyPath2D, lineWidth: number, x: number, y: number): boolean {
