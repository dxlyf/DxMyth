...
import { buildSimpleUvs, buildUvs } from './buildUvs';
import { transformVertices } from './transformVertices';
const shapeBuilders:Record<string,ShapeBuildCommand>={
    [buildRectangle.extension.name]:buildRectangle,
    [buildPolygon.extension.name]:buildPolygon,
    [buildTriangle.extension.name]:buildTriangle,
    [buildCircle.extension.name]:buildCircle,
    [buildEllipse.extension.name]:buildEllipse,
    [buildRoundedRectangle.extension.name]:buildRoundedRectangle,
}

type MeshGeometry=any
/**
